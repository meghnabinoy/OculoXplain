"""
Train MobileNetV2 on the merged RFMiD dataset with overfitting controls.
...
MODEL_STEM = "mobilenetv2_merged_rfmid"
CURVES_STEM = "training_curves_merged_rfmid_mobilenetv2"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional suffix for output files, e.g. 'pretrained' or 'scratch'",
    )
